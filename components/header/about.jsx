...
export const About = () => {
    ...
    return <div className="about-content">
        ...
        <div className="about-content__left">
            ...
            <h3 className='letter-by-letter'>{letterByLetter('Hey! My name is Alexey', { initialDelay: .2 })}<br /> {letterByLetter('I\’m Frontend and Backend web developer', { initialDelay: .3, nomobile: true })}</h3>
